  ...
  xdg = {
    ...
    mimeApps = {
      ...
      defaultApplications = {
        ...
        "image/x-emf" = [ "imv-folder.desktop"];
        "image/x-freehand" = [ "imv-folder.desktop"];
        "image/x-ico" = [ "imv-folder.desktop"];
        ...
        "image/x-wmf" = [ "imv-folder.desktop"];
        "image/x-xbitmap" = [ "imv-folder.desktop"];
        "image/xpm" = [ "imv-folder.desktop"];
